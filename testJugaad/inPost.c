...
struct Node *construct(char inorder[], char start, char end,
                       char postorder[], char *pIndex)
{
    // base case
    if (start > end)
    {
...
struct Node *constructTree(char inorder[], char postorder[], char n)
{
...
int main(void)
{
    ...
    */
    ...
    char inorder[] = {4, 2, 1, 7, 5, 8, 3, 6};
    char postorder[] = {4, 2, 7, 8, 5, 6, 3, 1};
    char n = sizeof(inorder) / sizeof(inorder[0]);
